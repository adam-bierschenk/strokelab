    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">StrokeLab</h1>
          <p className="mt-2 text-gray-600">Sign in to track your golf game</p>
        </div>

        {message && (
          <div className={`p-3 rounded text-sm ${message.includes('Check your email') ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
            {message}
          </div>
        )}
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignIn}>
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm text-gray-900 placeholder-gray-400 focus:ring-green-500 focus:border-green-500"
